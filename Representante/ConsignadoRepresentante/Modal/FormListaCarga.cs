...
namespace ConsignadoRepresentante.Modal
{
    public partial class FormListaCarga : MetroFramework.Forms.MetroForm
    {
        ...
        private void FormListaCarga_Load(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Este recurso não pode ser utilizado pois o servidor encontra-se offline no momento. Verifique sua conexão com o servidor e tente novamente.", "RederConsignado - Verificar Servidor", MessageBoxButtons.OK, MessageBoxIcon.Error);
                this.Close();
            }
