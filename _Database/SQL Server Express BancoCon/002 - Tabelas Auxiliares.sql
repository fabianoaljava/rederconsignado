...
IF OBJECT_ID('dbo.Cor', 'U') IS NOT NULL DROP TABLE Cor;
IF OBJECT_ID('dbo.Tamanho', 'U') IS NOT NULL DROP TABLE Tamanho;
IF OBJECT_ID('dbo.Cidade', 'U') IS NOT NULL DROP TABLE Cidade;
IF OBJECT_ID('dbo.Estado', 'U') IS NOT NULL DROP TABLE Estado;
IF OBJECT_ID('dbo.Pais', 'U') IS NOT NULL DROP TABLE Pais;
...
CREATE TABLE [dbo].[Cor](
	...
	[Abreviatura] [nchar](3) NULL,
	PRIMARY KEY CLUSTERED ([Id] ASC)
);

INSERT INTO Cor (Descricao, Abreviatura)
SELECT cor_nome, cor_codi FROM BancoCon.DBO.cor;
...
INSERT INTO Tamanho (Descricao, Abreviatura) VALUES ('SUPER PEQUENO','PP'), ('PEQUENO','P'), ('MÉDIO', 'M'), ('GRANDE', 'G'), ('EXTRA GRANDE', 'GG'), ('UNICO', 'U');
...
INSERT INTO Pais (Id, Descricao, Sigla) VALUES (1, 'Brasil', 'BR');
...
CREATE TABLE [dbo].[Estado](
	...
	[PaisId] [int] NOT NULL,
	PRIMARY KEY CLUSTERED ([Id] ASC),
	CONSTRAINT [FK_Estado_Pais] FOREIGN KEY ([PaisId]) REFERENCES [dbo].[Pais] ([Id])
);

INSERT INTO Estado (Id, Descricao, Sigla, PaisId) VALUES
(1, 'Acre', 'AC', 1),
(2, 'Alagoas', 'AL', 1),
(3, 'Amazonas', 'AM', 1),
(4, 'Amapá', 'AP', 1),
