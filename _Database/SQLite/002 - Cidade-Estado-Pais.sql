CREATE TABLE [RepPais](
	[Id] INTEGER PRIMARY KEY NOT NULL,
	[Descricao] text NULL,
	[Sigla] text NULL
);

INSERT INTO RepPais (Id, Descricao, Sigla) VALUES (1, 'Brasil', 'BR');

CREATE TABLE [RepEstado](
	[Id] INTEGER PRIMARY KEY NOT NULL,
	[Descricao] text NULL,
	[Sigla] text NULL,
...
INSERT INTO RepEstado (Id, Descricao, Sigla, PaisId) VALUES
(1, 'Acre', 'AC', 1),
(2, 'Alagoas', 'AL', 1),
(3, 'Amazonas', 'AM', 1),
(4, 'Amapá', 'AP', 1),
...
INSERT INTO RepCidade (Id, Descricao, EstadoId) VALUES
(1, 'Afonso Cláudio', 8),
